...
dat_clean= dat
plot(x= dat_clean$dattime, y= dat_clean$o1_crdw, col=2, type="l", ylab= "Oyster Clearance Rate (L/h/g DW)", xlab="Time", main=paste("Oyster Clearance Rate per Gram over Time for",date_long), ylim=c(-6,4))
#lines(x= dat_clean$dattime, y= dat_clean$o2_crdw, col= 3)
lines(x= dat_clean$dattime, y= dat_clean$o3_crdw, col= 4)
legend("bottomright", c("Oyster 1"#,"Oyster 2"
                     , "Oyster 3"), col = c(2,4),pch = 16)
dev.off()
```
